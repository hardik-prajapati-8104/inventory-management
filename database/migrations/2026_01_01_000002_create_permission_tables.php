...
/**
 * Standard Spatie Laravel Permission schema.
 * NOTE: normally you `php artisan vendor:publish` this from the package itself —
 * it is included here so the whole schema for Phase 1 is reviewable in one place.
 * If you already published the package's own migration, skip/delete this file.
 */
