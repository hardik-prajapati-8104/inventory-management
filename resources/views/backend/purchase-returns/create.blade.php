...
@section('title')
New Purchase Return - Vehicle Spare Parts Inventory
@endsection
...
<div class="page-title-area">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h4 class="page-title mb-1">New Purchase Return</h4>
            <ul class="breadcrumbs">
                <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                <li><a href="{{ route('admin.purchase-returns.index') }}">Purchase Returns</a></li>
                <li><span>New</span></li>
            </ul>
        </div>
        <div class="col-md-4 text-md-end mt-2 mt-md-0">
            <a href="{{ route('admin.purchase-returns.index') }}" class="btn btn-outline-secondary"><i class="bi bi-arrow-left"></i> Back</a>
        </div>
    </div>
</div>
    ...
    <div class="card-body">
        <form action="{{ route('admin.purchase-returns.store') }}" method="POST">
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <select name="purchase_id" class="form-select select2">
                        ...
                        @foreach ($purchases as $p)<option value="{{ $p->id }}">{{ $p->invoice_number }}</option>@endforeach
                    </select>
                </div>
                <div class="col-md-3">
            ...
            <table class="table table-bordered align-middle" id="itemsTable">
                <thead><tr><th>Spare Part</th><th width="12%">Quantity</th><th width="24%">Reason</th><th width="16%">Refund Amount</th><th width="5%"></th></tr></thead>
                <tbody id="itemRows">
                    <tr>
                        <td>
                        ...
                        <td><input type="text" name="reason[]" class="form-control" placeholder="e.g. Wrong part shipped"></td>
                        <td><input type="number" step="0.01" name="amount[]" min="0" value="0" class="form-control"></td>
            ...
            <div class="row mt-4">
                <div class="text-center col-12">
                    ...
                    <a href="{{ route('admin.purchase-returns.index') }}" class="btn btn-outline-secondary pr-4 pl-4">Cancel</a>
                </div>
            </div>
        </form>
    </div>
