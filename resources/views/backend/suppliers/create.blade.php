...
@section('title')
Add Supplier - Vehicle Spare Parts Inventory
@endsection
...
<div class="page-title-area">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h4 class="page-title mb-1">Add Supplier</h4>
        ...
        <form action="{{ route('admin.suppliers.store') }}" method="POST">
            ...
            <div class="row mt-4">
                <div class="text-center col-12">
                    <button type="submit" class="btn btn-add text-white pr-4 pl-4"><i class="bi bi-save"></i> Save Supplier</button>
