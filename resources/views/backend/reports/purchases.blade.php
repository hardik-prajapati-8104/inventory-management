...
@section('title')
Purchase Reports - Vehicle Spare Parts Inventory
@endsection
...
<div class="page-title-area">
    <div class="row align-items-center">
        <div class="col-md-8">
            <h4 class="page-title mb-1">Purchase Reports</h4>
        ...
        <div class="col-md-4 text-md-end mt-2 mt-md-0">
            <a href="{{ route('admin.reports.purchases', array_merge(request()->query(), ['export' => 'csv'])) }}" class="btn btn-outline-secondary"><i class="bi bi-download"></i> Export CSV</a>
        </div>
    </div>
</div>
...
<div class="row g-3 mb-3">
    <div class="col-md-4">
        <div class="vsp-kpi"><div class="vsp-kpi__icon"><i class="bi bi-cart-plus"></i></div><div><div class="vsp-kpi__value">₹{{ number_format($grandTotal, 2) }}</div><div class="vsp-kpi__label">Total Purchases ({{ $from }} to {{ $to }})</div></div></div>
    </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped align-middle">
                ...
                <tbody>
                    ...
                    @empty
                    <tr><td colspan="3" class="text-center text-muted py-4">No purchases in this range.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
